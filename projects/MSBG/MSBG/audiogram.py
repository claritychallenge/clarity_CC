...
def standard_audiograms():
    ...
    return [
        ...
        Audiogram(
            cfs=cfs,
            levels=np.array(
                [19, 19, 28, 35, 40, 47, 52, 56, 58, 58, 63, 70, 75, 80, 80],
            ),
        ),
    ]
...
class Audiogram:
    ...
    levels: np.ndarray
    cfs: np.ndarray = np.array(CONFIG.default_cfs)
